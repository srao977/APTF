# D01 Stage 2 Scoring Clarification Specification v0.2.1

**AUTHORITATIVE SOURCE:**  
`D01_STAGE_2_SCORING_CLARIFICATION_ADDENDUM_V0_2_1.md`

**IN CASE OF CONFLICT, THE FROZEN SCORING CLARIFICATION ADDENDUM V0.2.1 CONTROLS.**

This document is a canonical implementation-facing extract and does not create independent scientific authority.
